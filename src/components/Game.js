  ...
  return (
    <div className="wrapper">
      ...
      <form className="form" onSubmit={playGame}>
        ...
        <div className="game" role="radiogroup" aria-labelledby="label">
        ...
        <button className="btn" disabled={!userChoice || computerIsThinking}>
          {computerIsThinking ? "Your opponent is thinking..." : "Play"}
        </button>
      </form>
      <Results
